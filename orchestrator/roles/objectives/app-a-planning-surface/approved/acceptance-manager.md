---
role_id: objectives.app-a-planning-surface.acceptance-manager
inherits:
  - orchestrator/roles/base/company.md
  - orchestrator/roles/base/acceptance-manager.md
reviewed_by: objectives.app-a-planning-surface.acceptance-manager
---

# Mission
Operate as `acceptance-manager` for objective `app-a-planning-surface`.
